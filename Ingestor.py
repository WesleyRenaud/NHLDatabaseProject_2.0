...
class Ingestor:
    ...
    def get_all_skater_data( self ):
        ...
        for year in range( 1917, 2026 ):
            ...
            for season_type in range( 2, 4 ): # 2 = regular season, 3 = playoffs
                ...
                print( f'Fetched {len( data )} skater records for the {season} {season_type}' )
                ...
                for skater in data:
                    ...
                    if season_type == 'Regular Season':
                        curr_skater.add_season(
                            ...
                            time_on_ice_per_game = f"{skater['timeOnIcePerGame'] // 60}:{skater['timeOnIcePerGame'] % 60}" if
                                                            skater['timeOnIcePerGame'] != None else None,
    ...
    def get_all_goalie_data( self ):
        ...
        for year in range( 1917, 2026 ):
            ...
            for season_type in range( 2, 4 ): # 2 = regular season, 3 = playoffs
                ...
                print( f'Fetched {len( data )} goalie records for the {season} {season_type}' )
    ...
    def get_all_team_data( self ):
        ...
        for year in range( 1917, 2026 ):
            ...
            if season != '20042005':
                ...
                for team in data['standings']:
                    full_team_name = team['teamName']['default'].split( '(' )[0].strip()

                    curr_team = NHL.Team(
                        type = 'Regular Season',                    
                        season = team['seasonId'],
                        city = self.nhl_util.get_city( full_team_name ),
                        name = self.nhl_util.get_name( full_team_name ),
        ...
        for year in range( 1917, 2026 ):
            ...
            for team in data:
                full_team_name = team['teamFullName'].split( '(' )[0].strip()
